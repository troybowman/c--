...
# child 0 for node 21:
# node 22: type: TNT_ARRAY_LOOKUP
# child 0 for node 22:
# node 23: type: TNT_SYMBOL sym: x
# child 1 for node 22:
# node 24: type: TNT_INTCON val: 3
# child 1 for node 21:
# node 25: type: TNT_INTCON val: 4
# child 1 for node 20:
# node 26: type: TNT_STMT
# child 0 for node 26:
# node 27: type: TNT_ASSG
# child 0 for node 27:
# node 28: type: TNT_ARRAY_LOOKUP
# child 0 for node 28:
# node 29: type: TNT_SYMBOL sym: x
# child 1 for node 28:
# node 30: type: TNT_INTCON val: 4
# child 1 for node 27:
# node 31: type: TNT_INTCON val: 5
# child 1 for node 26:
# node 32: type: TNT_STMT
# child 0 for node 32:
# node 33: type: TNT_ASSG
# child 0 for node 33:
# node 34: type: TNT_ARRAY_LOOKUP
# child 0 for node 34:
# node 35: type: TNT_SYMBOL sym: x
# child 1 for node 34:
# node 36: type: TNT_INTCON val: 5
# child 1 for node 33:
# node 37: type: TNT_INTCON val: 6
#-----------------------------------------------------------------------------
...
# node 12: type: TNT_INTCON val: 1
# child 1 for node 9:
# node 13: type: TNT_CHARCON str: 'e'
# child 1 for node 8:
# node 14: type: TNT_STMT
# child 0 for node 14:
# node 15: type: TNT_ASSG
...
# node 18: type: TNT_INTCON val: 2
# child 1 for node 15:
# node 19: type: TNT_CHARCON str: 'l'
# child 1 for node 14:
# node 20: type: TNT_STMT
# child 0 for node 20:
# node 21: type: TNT_ASSG
...
# node 24: type: TNT_INTCON val: 3
# child 1 for node 21:
# node 25: type: TNT_CHARCON str: 'l'
# child 1 for node 20:
# node 26: type: TNT_STMT
# child 0 for node 26:
# node 27: type: TNT_ASSG
...
# node 30: type: TNT_INTCON val: 4
# child 1 for node 27:
# node 31: type: TNT_CHARCON str: 'o'
